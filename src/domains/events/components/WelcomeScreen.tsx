...
export function WelcomeScreen({onCreateUser}: WelcomeScreenProps) {
    ...
    return (
        ...
        >
            <div
                className="event-detail-enter w-full max-w-107.5 rounded-[28px] border border-white/10 bg-[#151915] p-7 shadow-[0_40px_100px_-25px_rgba(0,0,0,0.9)] sm:p-9">
        <span
            className="grid size-11 place-items-center rounded-2xl bg-lime-300 text-zinc-950 shadow-[0_12px_35px_-15px_rgba(190,242,100,0.6)]">
