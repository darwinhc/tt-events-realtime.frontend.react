import {CalendarDays, Check, Clock3, Edit3, LoaderCircle, MapPin, RotateCcw, Users,} from 'lucide-react'
    ...
    <article className="event-detail-enter">
      <div className="flex flex-col gap-6 border-b border-white/10 pb-8 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <h1
            className="max-w-2xl font-display text-4xl font-semibold leading-tight tracking-tighter text-white sm:text-5xl">
            {event.title}
          </h1>
