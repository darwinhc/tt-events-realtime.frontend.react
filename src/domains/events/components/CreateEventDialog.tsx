...
export function CreateEventDialog({
  ...
  return (
    <div
      ...
      role="dialog"
    >
      <div className="event-detail-enter max-h-[95vh] w-full max-w-140 overflow-y-auto rounded-t-[28px] border border-white/10 bg-[#151915] p-6 shadow-2xl sm:rounded-[28px] sm:p-8">
